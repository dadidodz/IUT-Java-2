...
public class TestPileBornee {
	...
	private PileBornee<Integer> pile;
	
	@Before
	public void setUp() throws Exception {
		pile = new PileBornee<Integer>(MAX_SIZE);
	}
	...
	public void testPush() throws Exception {
		PileBornee<Integer> p1 = new PileBornee<Integer>(2);
		p1.push(4);
	...
	public void testGetSize() throws Exception {
		PileBornee<Integer> pile = new PileBornee<Integer>(2);
